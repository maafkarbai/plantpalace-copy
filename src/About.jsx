const About = () => {
  return (
    <section className="mx-auto animate-fade ease-in-out py-20 p-6" id="About">
      <div className="flex sm:flex-row flex-col max-w-7xl bg-secondary text-white mx-auto p-6 rounded-md shadow-md">
        <img
          src="Images/AboutImage.jpg"
          className="drop-shadow-md h-96 object-cover"
        />

        <div className="my-auto p-3 flex flex-col gap-16 justify-center">
          <p className="text-5xl font-semibold text-center">Who Are We?</p>
